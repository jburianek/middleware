...
def sas_conn(value_raw):
    ...
    values = {
        ...
        0x8: 'unknown external connector type: 0x8',
        0x9: 'unknown external connector type: 0x9',
        0xa: 'unknown external connector type: 0xa',
        0xb: 'unknown external connector type: 0xb',
        0xc: 'unknown external connector type: 0xc',
        0xd: 'unknown external connector type: 0xd',
        0xe: 'unknown external connector type: 0xe',
